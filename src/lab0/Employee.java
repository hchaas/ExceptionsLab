...
public class Employee {
     ...
     */
    public Employee(String firstName, String lastName, String ssn, int daysVacation) throws IllegalArgumentException, IndexOutOfBoundsException{
    ...
    public final void setDaysVacation(int daysVacation) throws IndexOutOfBoundsException{
        if (daysVacation < 10 || daysVacation > 30){
            throw new IndexOutOfBoundsException("Invalid vacation days. Try again.");
        }
    ...
    public final void setSsn(String ssn) throws IllegalArgumentException{
        if (ssn.length() != 9 || ssn == null || ssn.isEmpty()){
            throw new IllegalArgumentException("Social security number must be 9 digits long.");
        }
        this.ssn = ssn;
    }
